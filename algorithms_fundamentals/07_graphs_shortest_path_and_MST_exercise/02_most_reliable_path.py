...
def get_reliability_dijstra(start_node, end_node, graph, parent, reliability):
...
path_reliability = get_reliability_dijstra(start_node, end_node, graph, parent, reliability)
